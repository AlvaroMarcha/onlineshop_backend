...
import es.marcha.backend.modules.catalog.application.dto.request.product.ProductAttribRequestDTO;
import es.marcha.backend.modules.catalog.application.dto.request.product.ProductAttribValueRequestDTO;
import es.marcha.backend.modules.catalog.application.dto.response.product.attrib.ProductAttribResponseDTO;
import es.marcha.backend.modules.catalog.application.dto.response.product.attrib.ProductAttribValueResponseDTO;
import es.marcha.backend.core.error.exception.ProductAttribException;
import es.marcha.backend.modules.catalog.application.mapper.ProductAttribMapper;
import es.marcha.backend.modules.catalog.application.mapper.ProductAttribValueMapper;
...
import es.marcha.backend.modules.catalog.infrastructure.persistence.ProductAttribRepository;
import es.marcha.backend.modules.catalog.infrastructure.persistence.ProductAttribValueRepository;
