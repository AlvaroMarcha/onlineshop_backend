...
import es.marcha.backend.modules.catalog.application.dto.request.ProductImageReorderItemDTO;
import es.marcha.backend.modules.catalog.application.dto.request.ProductImageUpdateRequestDTO;
...
import es.marcha.backend.modules.catalog.infrastructure.persistence.ProductImageRepository;
