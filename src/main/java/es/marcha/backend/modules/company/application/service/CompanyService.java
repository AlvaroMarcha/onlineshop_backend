package es.marcha.backend.modules.company.application.service;
...
import es.marcha.backend.modules.company.infrastructure.persistence.CompanyConfigRepository;
