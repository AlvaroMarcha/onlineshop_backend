...
public class JwtUtil {
    ...
    /**
     * Inicializa la clave secreta HMAC-SHA a partir del valor base64 configurado en {@code jwt.secret}.
     *
     * @param secret Valor de la clave secreta en formato base64, inyectado desde {@code application.properties}.
     */
     ...
     *
     * @param username El nombre de usuario que se incluye como {@code subject} en el token.
     ...
     * @return El {@code subject} del token, que corresponde al username del usuario.
